...
make
How to Play
Run the program. A secret 4-digit code will be generated.
You will be prompted to enter your guess.
After each guess, the program will give you two pieces of information:
...
Use this information to guess the secret code.
How to Stop the Game
The game can be stopped in three ways:

Guessing the Code Correctly: If you guess the secret code correctly, the game will stop and display a congratulatory message.
Exhausting All Attempts: The game will also stop if you have used up all your attempts without guessing the code correctly.
Manual Interruption: You can manually stop the game at any time by sending an interrupt signal. On most systems, this can be done by pressing Ctrl+C or Ctrl+D in the terminal where the game is running. This will immediately terminate the game. Please note that unsaved progress will be lost.
Rules
